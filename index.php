			...
			<?php if ($_SESSION['role'] == "admin") { ?>
				<div class="dashboard">
					<div class="dashboard-item">
						...
						<span><?=$num_users?> Developpeur</span>
					</div>
					<div class="dashboard-item">
						<i class="fa fa-tasks"></i>
						<span><?=$num_task?> Taches</span>
					</div>
					<div class="dashboard-item">
					...
					<div class="dashboard-item">
						...
						<span><?=$nodeadline_task?> Sans date limite</span>
					</div>
					<div class="dashboard-item">
						<i class="fa fa-exclamation-triangle"></i>
						<span><?=$todaydue_task?> Echeance aujourd'hui</span>
					</div>
					<div class="dashboard-item">
					...
					<div class="dashboard-item">
						...
						<span><?=$in_progress?> en Cour</span>
					</div>
					<div class="dashboard-item">
						<i class="fa fa-check-square-o"></i>
						<span><?=$completed?> Complet</span>
					</div>
				</div>
			<?php }else{ ?>
				<div class="dashboard">
