...
<body>
	...
	<div class="body">
		...
		<section class="section-1">
			<h4 class="title-2">
				<a href="create_task.php" class="btn">Creer une tache</a>
				<a href="tasks.php?due_date=Due Today">Terminer aujourd'hui</a>
				<a href="tasks.php?due_date=Overdue">en retard</a>
				<a href="tasks.php?due_date=No Deadline">Sans Echeance</a>
				<a href="tasks.php">Toutes les taches</a>
		...
		<?php } ?>
			...
			<table class="main-table">
	            ...
	            <td><?=$task['status']?></td>
					<td>
						<a href="edit-task.php?id=<?=$task['id']?>" class="edit-btn">Modifier</a>
						<a href="delete-task.php?id=<?=$task['id']?>" class="delete-btn">Spprimer</a>
					</td>
				</tr>
			   <?php	} ?>
			</table>
